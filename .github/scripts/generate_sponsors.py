...
The manually maintained source is ``.github/data/sponsors.json``. Public
sponsors use the following fields:
...
<!-- 此文件由 .github/data/sponsors.json 自动生成，请勿直接编辑名单。 -->
...
- 赞助后请备注希望展示的昵称并确认同意公开；昵称需符合社区规范，作者保留调整权。
